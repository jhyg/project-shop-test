...
function EgovNoticeDetail(props) {
    ...
    const retrieveDetail = () => {
        const retrieveDetailURL = `/inventories/${productId}`;
    ...
    fetchInventory(productId){
        axios.get(`/inventories/${productId}`)
        .then(response => {
    ...
    function deleteList(){
        axios.delete(`/inventories/${productId}`)
                    ...
                    <div className="contents NOTICE_VIEW" id="contents">
                        ...
                        <div className="board_view">
                            <div className="board_view_top">
                                <div className="tit">{productId}</div>
                                <div className="info">
                                    <dl>
                                        <dt>ProductId</dt>
                                        <dd>{productId}</dd>
                                    ...
                                    <dl>
                                        <dt>StockRemain</dt>
                                        <dd>{boardDetail && boardDetail.stockRemain }</dd>
                                    </dl>
                                </div>
                            </div>
