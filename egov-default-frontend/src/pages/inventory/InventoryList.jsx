...
function EgovNoticeList(props) {
    ...
    const retrieveList = useCallback((searchCondition) => {
        ...
        const retrieveListURL = '/inventories'+EgovNet.getQueryString(searchCondition);;
        ...
        EgovNet.requestFetch(retrieveListURL,
            ...
            (resp) => {
                ...
                // 리스트 항목 구성
                resp._embedded.inventories.forEach(function (item, index) {
                    ...
                    mutListTag.push(
                        <Link
                            ...
                            state={{
                                productId: item._links.self.href.split('/').pop(),
                                searchCondition: searchCondition
}}                            key={listIdx}
                            className="list_item">
                            <div>{item._links.self.href.split('/').pop()}</div>
                            <div>{item.stockRemain}</div>    
                        </Link>
                    );
                });
                        ...
                        <div className="condition">
                            <ul>
                                ...
                                <li className="third_2 R">
                                    ...
                                    <li>
                                        <Link to="/inventory/InventoryEdit" state={{bbsId: bbsId}} className="btn btn_blue_h46 pd35">등록</Link>
                                    </li>
                            </ul>
                        </div>
                        {/* <!--// 검색조건 --> */}
