...
function EgovNoticeEdit(props) {
    ...
    const updateBoard = () => {
        ...
        const entity = {
            ...
            stockRemain: boardDetail.stockRemain
        };
        ...
        return (
            <div className="location">
                <ul>
                    ...
                    <li><Link to="/inventory/inventories">Inventory</Link></li>
                ...
                <div className="layout">
                    ...
                    <div className="contents NOTICE_LIST" id="contents">
                        ...
                        <div className="board_view2">
                            ...
                            <dl>
                                <dt>
                                    <label htmlFor="nttSj">StockRemain</label>
                                </dt>
                                <dd>
                                    <input className="f_input2 w_full" id="stockRemain" name="stockRemain" type="text"
                                        onChange={e => setBoardDetail({ ...boardDetail, stockRemain: e.target.value })}
                                        maxLength="60" />
                                </dd>
                            </dl>
                            {/* <!-- 버튼영역 --> */}
                            <div className="board_btn_area">
                                ...
                                <div className="right_col btn1">
                                    <Link to="/inventory/inventories" className="btn btn_blue_h46 w_100">목록</Link>
                                </div>
                            </div>
                            {/* <!--// 버튼영역 --> */}
                        </div>
